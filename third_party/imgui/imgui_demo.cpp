...
static void ShowDemoWindowMenuBar(ImGuiDemoWindowData *demo_data) {
  ...
  if (ImGui::BeginMenuBar()) {
    ...
    if (ImGui::BeginMenu("Examples")) {
      ...
      ImGui::MenuItem(
          "Manipulating window titles", NULL, &demo_data->ShowAppWindowTitles);
    ...
    if (ImGui::BeginMenu("Tools")) {
...
#endif
      ImGui::MenuItem(
          "Metrics/Debugger", NULL, &demo_data->ShowMetrics, has_debug_tools);
      ImGui::MenuItem(
          "Debug Log", NULL, &demo_data->ShowDebugLog, has_debug_tools);
      ImGui::MenuItem(
          "ID Stack Tool", NULL, &demo_data->ShowIDStackTool, has_debug_tools);
      ...
      ImGui::MenuItem("Highlight ID Conflicts",
                      NULL,
                      &io.ConfigDebugHighlightIdConflicts,
                      has_debug_tools);
      ImGui::EndMenu();
...
static void ShowDemoWindowWidgets(ImGuiDemoWindowData *demo_data) {
  ...
  if (ImGui::TreeNode("Progress Bars")) {
    ...
    // animation speed.
    ImGui::ProgressBar(
        -1.0f * (float)ImGui::GetTime(), ImVec2(0.0f, 0.0f), "Searching..");
    ImGui::SameLine(0.0f, ImGui::GetStyle().ItemInnerSpacing.x);
  ...
  void Show() {
    ...
    if (ImGui::BeginTable("split", 3, ImGuiTableFlags_None)) {
      ...
      for (int side = 0; side < 2; side++) {
        ...
        ImGui::Text(
            "%s (%d)", (side == 0) ? "Available" : "Basket", items.Size);
        ...
        while (!use_clipper || clipper.Step()) {
          ...
          for (int n = item_begin; n < item_end; n++) {
            ...
            if (widget_type == WidgetType_Selectable) {
              ImGui::Selectable(
                  label, item_is_selected, ImGuiSelectableFlags_None);
            ...
            if (ImGui::BeginPopupContextItem()) {
              ...
              sprintf(
                  label, "Delete %d item(s)###DeleteSelected", selection.Size);
...
void ImGui::ShowStyleEditor(ImGuiStyle *ref) {
  ...
  if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None)) {
    if (ImGui::BeginTabItem("Sizes")) {
      ...
      ImGui::SliderFloat(
          "TabBarOverlineSize", &style.TabBarOverlineSize, 0.0f, 2.0f, "%.0f");
      ImGui::SameLine();
